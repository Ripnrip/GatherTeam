...
@property (nonatomic,strong) NSString *passedVenueName;
@property (nonatomic,strong) NSString *passedVenueLocation;
@property (nonatomic,strong) NSString *passedVenueType;
