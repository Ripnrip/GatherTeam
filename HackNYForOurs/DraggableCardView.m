...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self = [super initWithFrame:frame]) {
        //venueNames=@[@"restaurantOne",@"restaurantTwo",@"restaurantThree",@"restaurantFour",@"restaurantFive"];
...
-(void)getData{
    ...
    NSString *urlAsString = [NSString stringWithFormat:@"https://api.foursquare.com/v2/venues/search?ll=40.7,-74&client_id=%@&client_secret=%@&v=%@",foursquareClientKey,foursquareClientSecret,@"20160402"];
...
- (void)setup
{
    ...
    UILabel*venueName=[[UILabel alloc]initWithFrame:CGRectMake(10, 300, 150, 30)];
    [venueName setText:self.venueName];
    //[venueName setText:venueNames[1]];
    [self addSubview:venueName];
    
    UILabel*venueLocation=[[UILabel alloc]initWithFrame:CGRectMake(10, 330, 200, 30)];
    [venueLocation setText:@"Restaurant Location"];
    [self addSubview:venueLocation];
    
    UIButton*moreInfoButton = [[UIButton alloc]initWithFrame:CGRectMake(200, 330, 60, 60)];
    [moreInfoButton setImage:[UIImage imageNamed:@"info"] forState:UIControlStateNormal];
    [self addSubview:moreInfoButton];
    
    UILabel*venueType=[[UILabel alloc]initWithFrame:CGRectMake(10, 360, 150, 30)];
    [venueType setText:@"Restaurant Type"];
    [self addSubview:venueType];
...
- (void)createOverlayView
{
    ...
    self.overlayView.venueImageView = self.venueImage;
    self.overlayView.venueName = @"VenueName";
