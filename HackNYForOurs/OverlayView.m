...
@property (nonatomic, strong) UIImageView *venueImageView1; // for signs
...
- (void)setup
{
    ...
    //self.venueImageView1 = [[UIImageView alloc] initWithFrame:self.bounds];
    //self.venueImageView1.contentMode = UIViewContentModeRedraw;
    self.venueName = @"someVenueName";
    [self addSubview:self.imageView];
    //[self addSubview:self.venueImageView1];
